...
class Hyperparameters():
    ...
    # Streaming log-bias (Nacrith arXiv:2602.19626)
    log_bias_enabled = bool(int(os.environ.get('LOG_BIAS_ENABLED', '0')))
...
def train_and_eval(h: Hyperparameters, device: torch.device) -> None:
    ...
    if h.log_bias_enabled:
        timed_eval("log_bias_sliding_window", eval_val_sliding_log_bias,
